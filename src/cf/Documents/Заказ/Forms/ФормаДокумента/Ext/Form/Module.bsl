...
//++ Task-1: Запрет редактирования закрытого заказа, кроме полных прав Шихарбеева 12.01.25
&НаСервере
...
#КонецЕсли  
//++ Task-1: Запрет редактирования закрытого заказа, кроме полных прав Шихарбеева 12.01.25
	Если Объект.СостояниеЗаказа= ПредопределенноеЗначение("Перечисление.СостоянияЗаказов.Закрыт") И НЕ РольДоступнаНаСервере("Администратор") тогда
		 ЭтаФорма.ТолькоПросмотр=Истина;  
		 Сообщить(НСтр("ru = 'Редактирование закрытого заказа доступно только администратору'", "ru"));
	КонецЕсли;	 
//-- Task-1: Запрет редактирования закрытого заказа, кроме полных прав Шихарбеева 12.01.25
